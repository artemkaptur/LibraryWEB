...
<body>
	...
	<h1>Type in books id which should be updated and info about new
		book</h1>
	<br />

	<form method="post" action="s6">
		Books id <label><input type="number" name="books_id"></label><br>
		Title <label><input type="text" name="title"></label><br>
		Brief <label><input type="text" name="brief"></label><br>
		Publish year <label><input type="number" name="publish_year"></label><br>
	...
	<div class="container container-footer">
		...
		src="assets/js/bs-animation.js"></script>
</body>
