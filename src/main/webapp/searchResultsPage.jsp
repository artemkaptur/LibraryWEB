...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="nav-1">
			<ul class="nav navbar-nav">
				...
				<li role="presentation"><a href="booksPage.jsp">Books </a></li>
				<li role="presentation"><a href="employeesPage.jsp"> Emolyees</a></li>
			</ul>
		</div>
	</div>
	</nav> </section>
	...
	<h1>View report by employees who read books</h1>
	<br />

	<form method="post" action="ss">
		More then <label><input type="number" name="low_border"></label><br>
		And less then <label><input type="number" name="hight_border"></label><br>
		<input type="submit" value="Search" name="Ok"><br>
	</form>

	<h2>Search results</h2>
	<br />

	<c:forEach var="employeeBook" items="${requestScope.employeeBooks}">
		<ul>

			<li>Name: <c:out value="${employeeBook.employeeName}" /></li>

			<li>Book count: <c:out value="${employeeBook.bookCount}" /></li>
		</ul>
		<hr />
	</c:forEach> </section>
