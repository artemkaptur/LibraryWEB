...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="nav-1">
			<ul class="nav navbar-nav">
				...
				<li role="presentation"><a href="createBookPage.jsp">Create
				</a></li>
				<li role="presentation"><a href="deleteBookPage.jsp">Delete
				</a></li>
				<li role="presentation"><a href="updateBookPage.jsp">
						Update</a></li>
				<li role="presentation"><a href="SearchByTitlePage.jsp"> Search</a></li>
			</ul>
		</div>
	</div>
	</nav> </section>
	...
	<form method="post" action="sss">
		<input type="submit" value="Show current books in Library" name="Ok"><br>
	</form>
	...
	<c:forEach var="book" items="${requestScope.books}">
		<ul>
			...
			<li>Brief: <c:out value="${book.brief}" /></li>

			<li>Publish year: <c:out value="${book.publishYear}" /></li>
