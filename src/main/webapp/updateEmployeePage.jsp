...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="nav-1">
			<ul class="nav navbar-nav">
				...
				<li role="presentation"><a href="employeesPage.jsp">
						Emolyees</a></li>
			</ul>
		</div>
	</div>
	...
	<h1>Type in employees id which should be updated and info about
		new employee</h1>
	<br />

	<form method="post" action="s11">
		Employees id <label><input type="number" name="employees_id"></label><br>
		Name <label><input type="text" name="name"></label><br>
		Surname <label><input type="text" name="surname"></label><br>
		Birth date <label><input type="text" name="birth_date"></label><br>
